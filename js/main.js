        ...
        jQuery('.bringer-lightbox-link').each(function () {
          ...
          if ($this.attr('data-type') && $this.attr('data-type') !== 'image') {
            ...
            if ('video' === $this.attr('data-type')) {
              this_item.html =
                '\
                            <div class="bringer-pswp-media--video" data-src="' +
                $this.attr('href') +
                '">\
                                <video src="' +
                $this.attr('href') +
              ...
              this_item.html =
                '\
                            <div class="bringer-pswp-media--iframe" data-player-src="' +
                this_link +
                '" data-src="' +
                $this.attr('href') +
                '" data-type="' +
            ...
            if ($this.attr('data-size')) {
              ...
              if ($this.children('img').attr('width')) this_item.w = $this.children('img').attr('width');
              if ($this.children('img').attr('height')) this_item.w = $this.children('img').attr('height');
            }
                  ...
                  .each(function () {
                    ...
                    if (template.inView(this)) {
                      ...
                      $this_video
                        ...
                        .attr(
                          'src',
                          $this_video.attr('data-player-src') + '?controls=1&amp;loop=0&amp;autoplay=1&amp;muted=1',
                        );
                    } else {
                      $this_video.removeClass('is-inview');
                      $this_video
                        .children('iframe')
                        .attr('src', jQuery(this).attr('data-src') + '?controls=1&amp;loop=0');
                    }
                  });
              }
            });
        ...
        jQuery('.swiper').each(function () {
          ...
          if ($this.hasClass('bringer-carousel')) {
            ...
            options.slidesPerView =
              $this.attr('data-m-count') !== undefined ? parseFloat($this.attr('data-m-count')) : 1;
            options.breakpoints = {
              739: {
                // Tabled Port
                slidesPerView: $this.attr('data-tp-count') !== undefined ? parseFloat($this.attr('data-tp-count')) : 2,
                centeredSlides:
                  $this.attr('data-tp-centered') !== undefined ? parseInt($this.attr('data-tp-centered'), 10) : true,
              },
              960: {
                // Tabled Land
                slidesPerView: $this.attr('data-t-count') !== undefined ? parseFloat($this.attr('data-t-count')) : 3,
                centeredSlides:
                  $this.attr('data-t-centered') !== undefined ? parseInt($this.attr('data-t-centered'), 10) : true,
              },
              1200: {
                // Desktop
                slidesPerView: $this.attr('data-count') !== undefined ? parseFloat($this.attr('data-count')) : 3,
                centeredSlides:
                  $this.attr('data-centered') !== undefined ? parseInt($this.attr('data-centered'), 10) : true,
              },
            };
          }
          ...
          if ($this.hasClass('bringer-slider')) {
            ...
            options.autoplay =
              $this.attr('data-autoplay') !== undefined ? { delay: parseInt($this.attr('data-autoplay'), 10) } : false;
  ...
  function InitAnimation() {
    ...
    if (jQuery('[data-stagger-appear]').length) {
      jQuery('[data-stagger-appear]').each(function () {
        let $parent = jQuery(this),
          delay_step =
            $parent.attr('data-stagger-delay') !== undefined ? parseInt($parent.attr('data-stagger-delay'), 10) : 50,
          ...
          unload_type =
            $parent.attr('data-stagger-unload') !== undefined ? $parent.attr('data-stagger-unload') : 'none';
    ...
    if (jQuery('[data-split-appear]').length) {
      jQuery('[data-split-appear]').each(function () {
        ...
        const _self = this;
        let anim_type =
          this.getAttribute('data-split-appear') !== null ? this.getAttribute('data-split-appear') : 'fade-up';
        let unload_type =
          this.getAttribute('data-split-unload') !== null ? this.getAttribute('data-split-unload') : 'none';
        let duration =
          this.getAttribute('data-duration') !== null ? parseInt(this.getAttribute('data-duration'), 10) : 500;
        let split_by = this.getAttribute('data-split-by') !== null ? this.getAttribute('data-split-by') : 'line';
        let delay =
          this.getAttribute('data-split-delay') !== null ? parseInt(this.getAttribute('data-split-delay'), 10) : 100;
